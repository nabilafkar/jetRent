...
<body class="bg-midnight">
    ...
    <div x-data="{ scrolled: false }" x-on:scroll.window="scrolled = (window.scrollY > 50)"
        :class="{ 'bg-transparent rounded-b-lg': !scrolled, 'bg-lightGrey shadow-md rounded-b-lg': scrolled }"
